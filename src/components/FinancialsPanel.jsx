...
export function FinancialsPanel() {
  ...
  return (
    <div className="sec-panel" id="sec-panel-financials" role="tabpanel" aria-label="Financials">
      <div className="content company-summary">
        ...
        <div className="intel-table-scroll company-summary-scroll">
          <table className="intel-table2 company-summary-table" aria-label="Financials table">
            <thead>
              <tr>
                <th>Company</th>
